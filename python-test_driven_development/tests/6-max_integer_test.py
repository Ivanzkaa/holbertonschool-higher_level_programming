...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_one_negative(self):
                self.assertEqual(max_integer([-2, 6, 9]), 9)
    ...
    def test_big_number(self):
                big_num = 300000000000000000000000000000000000000000005
                self.assertEqual(max_integer([big_num, 5]),
                                300000000000000000000000000000000000000000005)

    def test_a_string(self):
        self.assertEqual(max_integer("si"), 's')

    def test_list_of_floats(self):
        self.assertEqual(max_integer([3.9, 8.9, 6.8]), 8.9)
